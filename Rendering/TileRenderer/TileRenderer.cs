...
public static class TileRenderer
{
    public static BaseShape Tessellate(this MapFeatureData feature, ref BoundingBox boundingBox, ref PriorityQueue<BaseShape, int> shapes)
    {
        ...
        if (feature.geographicType == GeographicType.highway)
        {
        ...
        else if (feature.geographicType == GeographicType.river)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.border)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.populatedplace)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.railway)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.plain)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.forest)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.mountain)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.desert)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.water)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.geographicType == GeographicType.residential)
        {
            var coordinates = feature.Coordinates;
